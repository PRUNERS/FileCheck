...
from LLVM.
It has [[https://github.com/llvm-mirror/llvm.git][llvm-mirror/llvm]] as sub-module and a custom CMakeLists.txt to separately build and install those two tools.
